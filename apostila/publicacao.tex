...
\include{./docs/lista_exercicios}

\inicioIntroducao %% não altere este comando

\include{./docs/capitulo1} %% 1o capítulo, começo do texto

\include{./docs/capitulo2} %% 2o capítulo

\include{./docs/capitulo3} %% 3o capítulo

\include{./docs/capitulo4} %% 4o capítulo
