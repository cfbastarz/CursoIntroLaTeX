...
%    enhanced,
%    colframe=MaterialOrange500,
%    colback=white,
%    coltitle=white,
%    fonttitle=\bfseries,
%    underlay={\begin{tcbclipinterior}
%        \shade[inner MaterialOrange500,outer color=white]
%            (interior.north west) circle (2cm);
%        \draw[help lines,step=5mm,MaterialOrange500,shift={(interior.north west)}]
...
\tcbset{texercisestyle/.style={arc=0.5mm, colframe=MaterialOrange,
    ...
    listing options={style=tcblatex,texcsstyle=*\color{white}},
}}
