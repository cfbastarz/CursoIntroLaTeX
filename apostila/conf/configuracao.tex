% CAPA
\titulo{Introdução ao \LaTeX{}}
\title{Introduction to \LaTeX{}} 
\author{Carlos Frederico Bastarz}
\descriccao{Apostila de introdução à linguagem de marcação \LaTeX{}.}
...
\cutterFICHAC{Cutter}
\autorUltimoNomeFICHAC{Sobrenome, Nomes}
\autorFICHAC {Nome Completo do Autor1; Nome Completo do Autor2}
...
\tipoTD{Dissertação ou Tese} 
\cursoFA{Mestrado ou Doutorado em Nome do Curso}
\instituicaoDefesa{Instituto Nacional de Pesquisas Espaciais}
\anoDefesa{AAAA} 
\nomeAtributoOrientadorFICHAC{Orientador}
\valorAtributoOrientadorFICHAC{José da Silva}
