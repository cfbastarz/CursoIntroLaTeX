...
\vspace{6mm}
    \begin{center}
        \includegraphics[scale=0.3]{./figs/biblio_pub_latex.pdf}
    \end{center}
\vspace{4mm}
...
\vspace{6mm}
    \begin{center}
        \includegraphics[scale=0.3]{./figs/estrutura_estilo_inpe.pdf}
    \end{center}
\vspace{4mm}
...
\vspace{6mm}
    \begin{center}
        \includegraphics[scale=0.4]{./figs/saida_execpub.pdf}
    \end{center}
\vspace{4mm}
...
\vspace{6mm}
    \begin{center}
    	%\label{fig:leiame1}
        \subfigure[Representação errada]{\includegraphics[scale=0.35]{./figs/exemplo_iso8859_1.pdf}}%\\
		%\label{fig:leiame2}
		\subfigure[Representação correta]{\includegraphics[scale=0.35]{./figs/exemplo_iso8859_3.pdf}}
    \end{center}
\vspace{4mm}
...
Tanto para figuras quanto para tabelas, o posicionamento destes corpos flutuantes é importante. Os ambientes {\tt figure} e {\tt table}, devem ter suas posições relativas ajustadas conforme as opções mostradas na Tabela \ref{tab:ambfig} da Seção \ref{sec:amb_figs} do Capítulo \ref{cap:parteII}.
...
\begin{figure}[H]
	...
	\vspace{6mm}
	\begin{center}
		\includegraphics[scale=0.6,angle=-90,trim={4.5cm 1cm 6cm 1cm},clip]{./figs/diagramacompbib.pdf}
	\end{center}
	\vspace{4mm}
