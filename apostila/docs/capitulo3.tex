...
%\begin{figure}[H]
%\centering
%\subfigure[Renderização errada\label{fig:leiame1}]{\includegraphics[scale=0.35]{./docs/figs/exemplo_iso8859_1.png}}%\\
%\subfigure[Renderização correta\label{fig:leiame2}]{\includegraphics[scale=0.35]{./docs/figs/exemplo_iso8859_3.png}}
