...
\begin{marker}
Se o documento a ser compilado possuir título e partes, como capítulos, seções, subseções etc, será nacessário executar o comando {\tt latex exe\_doc.tex} duas vezes. Dependendo da estrutura do documento, e.g., se ele contém um sumário, outros arquivos intermediários poderão ser criados.
\end{marker}
...
\subsection{Acentos e Localização}
\label{sec:acentos}
...
\begin{itemize}
    \item \mintinline{latex}{\usepackage[brazilian]{babel}}\footnotemark[1]
    \item \mintinline{latex}{\usepackage[T1]{fontenc}}
    \item \mintinline{latex}{\usepackage[utf8]{inputenc}}\footnotemark[2]
\end{itemize}

\footnotetext[1]{Este pacote é apenas necessário para traduzir alguns elementos textuais, como as palavras \text     it{Table}, \textit{Figure}, o formato da data etc.}
\footnotetext[2]{Pode-se utilizar também o pacote {\tt latin1}, com o comando \mintinline{latex}{\usepackage[latin1]{inputenc}}. Ambos os pacotes, {\tt utf-8} e {\tt latin1} fornecem o suporte ao UNICODE. Se o usuário quiser utilizar o formato \textit{OpenType}, evite utilizar estes pacotes e utilize compiladores mais modernos como o \XeLaTeX{} ou o \LuaTeX{}.}
...
\begin{marker}
  As imagens do Exemplo \ref{exe_fig1} acima foram incluídas com o pacote \mintinline{latex}{graphicx} que possui diversas imagens de exemplos. Veja mais sobre este pacote em \url{https://www.ctan.org/pkg/graphicx}.
\end{marker}
...
Outro ambiente que pode ser usado para listar \textit{scripts} e programas é o {\tt minted}. Veja o exemplo a seguir:
