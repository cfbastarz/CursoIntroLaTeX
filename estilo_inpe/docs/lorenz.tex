...
\begin{figure}[ht]
\centering \resizebox{12cm}{!}{\includegraphics{docs/figs/roloconveclorenz.png}} 
...
\begin{figure}[ht]
\centering \resizebox{10cm}{!}{\includegraphics{docs/figs/lorenzseriex.png}} 
...
\begin{figure}[ht]
\centering \resizebox{10cm}{!}{\includegraphics{docs/figs/lorenzseriexci.png}} 
...
\begin{figure}[ht]
\centering 
\resizebox{6cm}{!}{\includegraphics{docs/figs/figlorenzxtriplo1.png}} \resizebox{6cm}{!}{\includegraphics{docs/figs/figlorenzxtriplo2.png}} \\  \resizebox{6cm}{!}{\includegraphics{docs/figs/figlorenzxtriplo3.png}} 
...
\begin{figure}[ht]
\centering \resizebox{12cm}{!}{\includegraphics{docs/figs/atratorlorenzcomprojecoes.png} } 
