...
\begin{figure}[ht]
\centering 
\resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzst.png}} \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzespectrogrid.png}} \\  \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzautocorrgrid.png}} 
...
\begin{figure}[ht]
\centering 
\resizebox{15cm}{!}{\includegraphics{docs/figs/lorenzpack1.png}\includegraphics{docs/figs/lorenzpack2.png}}
...
\begin{figure}[ht]
\centering 
\resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzatraso1.png}} \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzatraso2.png}} \\  \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzatraso3.png}} 
...
\begin{figure}[ht]
\centering 
\resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzreconstbi1.png}} \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzreconstbi12.png}} \\  \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzreconstbi50.png}} 
...
\begin{figure}[ht]
\centering 
\resizebox{15cm}{!}{\includegraphics{docs/figs/lorenzproj1.png}\includegraphics{docs/figs/lorenzproj2.png}}
...
\begin{figure}[ht]
\centering 
\resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzst.png}} \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzcorrelint2.png}} \\  \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzdimcorrel2.png}} 
...
\begin{figure}[ht]
\centering 
\resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzxsurr.png}} \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzcorrelint2surr.png}} \\  \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzdimcorrelsurr2.png}} 
...
\begin{figure}[ht]
\centering 
\resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzdiff2.png}} \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzcorrelintdiff2.png}} \\  \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzdimcorreldiff2.png}} 
...
% \begin{figure}[ht]
% \centering \resizebox{15cm}{!}{\includegraphics{docs/figs/figestacionaria.png}}
...
\begin{figure}[!ht]
\begin{center}
\resizebox{12cm}{!}{\input{docs/figs/estacionariaxfig2.pdftex_t}}
\caption{Janelas de dados deslizantes} 
\end{center}
\label{figestaciogeral}
\end{figure}
...
\begin{figure}[ht]
\centering \resizebox{13cm}{!}{\includegraphics{docs/figs/wolf.png}}
...
\begin{figure}[ht]
\centering \resizebox{13cm}{!}{\includegraphics{docs/figs/lorenzlyap3cond.png}}
...
\begin{figure}[ht]
\centering 
\resizebox{7.2cm}{!}{\includegraphics{docs/figs/ruidorp.png}} \resizebox{7.2cm}{!}{\includegraphics{docs/figs/senorp.png}} \\  \resizebox{7.2cm}{!}{\includegraphics{docs/figs/lorenzrp.png}} 
...
% \begin{figure}[ht]
% \centering 
% \resizebox{13cm}{!}{\includegraphics{docs/figs/lorenzdet.png}\includegraphics{docs/figs/lorenzembardet.png}}
% \caption{Atrator de Lorenz para o sistema~(\ref{eqsistemalorenzpart}). (a) Atrator original. (b) Atrator reconstruído pelo método das derivadas.}
% \label{lorenzdiff}
% \end{figure}
