...
\begin{frame}{Estrutura e Organização}
    ...
    {\scriptsize
        ...
        \begin{itemize}[leftmargin=0pt, itemindent=0pt,labelwidth=15pt,labelsep=0pt, listparindent=0cm,align=left]
            ...
            \item tdiinpe.cls}                                                        
            \pause
            \color{InpeLaranja}{\item abntex-abrev-pt\_BR.def      
...
%        \begin{itemize}[label=\textbullet]
%            \item {\tt cite}: \cite{fulano/1964}
%            \item {\tt citeonline}: \citeonline{fulano/1964}
%            \item {\tt citeyear}: \citeyear{fulano/1964}
%            \item {\tt citeauthor}: \citeauthor{fulano/1964}
%            \item {\tt citeauthoronline}: \citeauthoronline{fulano/1964}
%        \end{itemize}
%    \end{block}
%\end{frame}
