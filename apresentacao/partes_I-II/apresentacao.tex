...
\begin{texexptitled}[breakable,center lower,enhanced jigsaw,middle=2mm,listing side comment,righthand width=3.5cm,compilable listing,run latex,run dvips,run ps2pdf,pdf comment,comment style={raster columns=1},freeze pdf]{Um documento \LaTeX{} mínimo}{exe_doc}
...
\begin{frame}[fragile]{Compilação de um documento \LaTeX{}}
    \begin{block}{Linha de comando\footnote{Se for utilizado o compilador \XeLaTeX{}, o arquivo PDF será criado automaticamente}. Além disso, estes comandos aceitam opções.}
        \begin{tcblisting}{colback=yellow!5,colframe=yellow!50!black,listing only,title=Documento simples,fonttitle=\bfseries,listing engine=minted,minted language=bash}
            latex documento.tex
            dvips documento.dvi
            ps2pdf documento.ps
        \end{tcblisting}
    
        \begin{tcblisting}{colback=yellow!5,colframe=yellow!50!black,listing only,title=Documento com referência Bib\TeX{},fonttitle=\bfseries,listing engine=minted,minted language=bash}
            latex documento.tex
            bibtex documento
            latex documento
            latex documento
...
\begin{frame}[fragile]{Localização e acentos}
\begin{texexptitled}[breakable,center lower,enhanced,middle=2mm,listing side text,righthand width=2.5cm]{Uso de acentos latinos no \LaTeX{}}{exe_acentos}
\'A \'E \'I \'O \'U
...
\begin{texexptitled}[breakable,center lower,enhanced,middle=2mm,listing side text,righthand width=2cm]{Marcações mais mais comuns em fontes}{exe_estilos}
\textit{itálico}       \\
\textsl{inclinado}     \\
...
\begin{frame}[fragile]{Tipos, tamanhos e estilos de letras}
\begin{texexptitled}[breakable,center lower,enhanced,middle=2mm,listing side text,righthand width=2cm]{Tamanhos de fontes}{exe_tamfonte}
{\Huge Huge}                 \\
{\huge huge}                 \\
{\LARGE LARGE}               \\
{\Large Large}               \\
...
\begin{frame}[fragile]{Tipos, tamanhos e estilos de letras}
\begin{texexptitled}[breakable,center lower,enhanced,middle=2mm]{Estilos de fontes, máquina de escrever ({\tt texttt})}{exe_font}
\texttt{Máquina de Escrever} | \texttt{\textit{Máquina de Escrever, em itálico}} | \texttt{\textsl{Máquina de Escrever, inclinado}}
\end{texexptitled}
\end{frame}

\begin{frame}[fragile]{Tipos, tamanhos e estilos de letras}
\begin{texexptitled}[breakable,center lower,enhanced,middle=2mm]{Estilos de fontes, sem serifa ({\tt textsf})}{exe_font}
\textsf{Sem Serifa} | \textsf{\textit{Sem Serifa, em itálico}} | \textsf{\textsl{Sem Serifa, inclinado}}
\end{texexptitled}
\end{frame}

\begin{frame}[fragile]{Tipos, tamanhos e estilos de letras}
\begin{texexptitled}[breakable,center lower,enhanced,middle=2mm]{Estilos de fontes, com serifa ({\tt textrm})}{exe_font}
...
\setbeamercolor{background canvas}{bg=white}
\begin{frame}[plain,fragile]{}
\begin{texexptitled}[breakable,center lower,enhanced jigsaw,middle=2mm,listing side comment,righthand width=2cm,compilable listing,run latex,run dvips,run ps2pdf,pdf comment,comment style={raster columns=1},freeze pdf]{Largura relativa com a \textit{macro} {\tt textwidth}}{exe_meds1}
...
\begin{frame}[fragile]{Parágrafos}
\begin{texexptitled}[breakable,enhanced,middle=2mm]{Parágrafos com quebra de linha, separados por duas barras invertidas (\mintinline{latex}{\\})}{exe_par3}
\lipsumsentence[1-4] \\
\lipsumsentence[5-8]
\end{texexptitled}
\end{frame}
...
\begin{frame}[fragile]{Parágrafos}
\begin{texexptitled}[breakable,enhanced,middle=2mm]{Novo parágrafo iniciado pelo comando {\tt par}}{exe_par5}
...
\begin{frame}[fragile]{Parágrafos}
\begin{texexptitled}[breakable,enhanced,middle=2mm]{Novo parágrafo iniciado pelo comando {\tt par}, com recuo especial}{exe_par6}
...
\begin{frame}[fragile]{Parágrafos}
\begin{texexptitled}[breakable,enhanced,middle=2mm]{Novo parágrafo iniciado pelo comando {\tt par}, com recuo ({\tt parindent}) e espaçamento ({\tt parskip}) especiais}{exe_par7}
\setlength{\parindent}{3em}
...
%\begin{texexptitled}[breakable,enhanced,middle=2mm]{Novo parágrafo iniciado pelo comando {\tt par}, com recuo ({\tt parindent}), espaçamento entre parágrafos ({\tt parskip}) e altura de linha ({\tt baselinestretch}) especiais}{exe_par8}
%\setlength{\parindent}{3em}
%\setlength{\parskip}{1em}
...
\setbeamercolor{background canvas}{bg=white}
\begin{frame}[plain,fragile]{}
\begin{texexptitled}[breakable,center lower,enhanced jigsaw,middle=2mm,listing side comment,righthand width=4cm,compilable listing,run latex,run dvips,run ps2pdf,pdf comment,comment style={raster columns=1},freeze pdf]{Espaçamento de linha simples ({\tt baselinestretch, 1.0})}{exe_par8}
\documentclass{article}
\usepackage[utf8]{inputenc}
\usepackage{lipsum}
...
\setbeamercolor{background canvas}{bg=white}
\begin{frame}[plain,fragile]{}
\begin{texexptitled}[breakable,center lower,enhanced jigsaw,middle=2mm,listing side comment,righthand width=4cm,compilable listing,run latex,run dvips,run ps2pdf,pdf comment,comment style={raster columns=1},freeze pdf]{Espaçamento de linha médio ({\tt baselinestretch, 1.3})}{exe_par9}
\documentclass{article}
\usepackage[utf8]{inputenc}
\usepackage{lipsum}
...
\setbeamercolor{background canvas}{bg=white}
\begin{frame}[plain,fragile]{}
\begin{texexptitled}[breakable,center lower,enhanced jigsaw,middle=2mm,listing side comment,righthand width=4cm,compilable listing,run latex,run dvips,run ps2pdf,pdf comment,comment style={raster columns=1},freeze pdf]{Espaçamento de linha duplo ({\tt baselinestretch, 1.6})}{exe_par10}
\documentclass{article}
\usepackage[utf8]{inputenc}
\usepackage{lipsum}
...
%\begin{frame}[fragile,plain]{}
%\begin{texexptitled}[breakable,enhanced,middle=2mm]{Citando uma figura}{exe_ambfig}
%\begin{figure}[H]
%    \label{fig:exe_img_a}
%    \caption{Uma figura.}
...
\begin{frame}[fragile,plain]{}
\begin{texexptitled}[breakable,center,enhanced,middle=2mm,width=0.92\paperwidth]{Ambiente {\tt multline}}{exe_eq3}
\begin{multline*}
...
%
%\begin{frame}[fragile]{Citações e Referências}
%\end{frame}
%
%\begin{frame}[fragile]{Citações e Referências}
%\end{frame}
